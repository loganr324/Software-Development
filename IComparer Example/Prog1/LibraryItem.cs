...
namespace LibraryItems
{
    public abstract class LibraryItem : IComparable<LibraryItem>
    {
        ...
        //Precondition: None
        //Postcondition:when this < item2, return a negative #
        //              when this = item2, return 0 
        //              when this > item2, return a positive #
        public int CompareTo(LibraryItem item2)
        {
            if (item2 == null) //How to handle a null value for item2
                return 1;

            return this.Title.CompareTo(item2.Title); //Uses the titles of the items when sorting
        }
    }
}
